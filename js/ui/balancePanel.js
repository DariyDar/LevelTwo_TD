...
const BALANCE_PARAMS = [
  { key: 'STARTING_WORKERS', label: 'Starting Glycogen Pool (workers at start)', desc: 'Initial glucose stored in muscle cells', min: 2, max: 40, step: 1 },
  { key: 'ENERGY_START', label: 'Starting ATP (energy bar)', desc: 'Initial energy reserves', min: 50, max: 500, step: 10 },
  { key: 'ENERGY_BASAL_DRAIN', label: 'Basal Metabolic Rate (energy drain/s)', desc: 'Resting energy consumption per second', min: 4, max: 30, step: 1 },
  { key: 'WORKER_LIFETIME', label: 'Glucose Uptake Duration (worker life, sec)', desc: 'Seconds before a muscle cell consumes its glucose', min: 3, max: 60, step: 1 },
  { key: 'MINE_ENERGY_PER_WORKER', label: 'ATP per Glycolysis (energy per worker/s)', desc: 'Energy produced per active muscle cell per second', min: 0.1, max: 1.0, step: 0.05 },
  { key: 'KNIGHT_SPEED', label: 'GLUT Transporter Speed (knight speed, px/s)', desc: 'Movement speed of liver GLUT2 transporters', min: 10, max: 1000, step: 10 },
  { key: 'LIVER_MAX_KNIGHTS', label: 'Max GLUT Transporters (max knights)', desc: 'Maximum number of liver GLUT2 transporters', min: 1, max: 10, step: 1 },
  { key: 'LIVER_AUTO_SPAWN_INTERVAL', label: 'GLUT Synthesis Rate (knight spawn, sec)', desc: 'Seconds between auto-spawning new transporters', min: 1, max: 15, step: 0.5 },
  { key: 'LIVER_BONUS_KNIGHT_COUNT', label: 'Metformin GLUT Boost (bonus knights)', desc: 'Extra transporters spawned by Metformin click', min: 1, max: 20, step: 1 },
  { key: 'KNIGHT_INTERCEPT_CHANCE', label: 'GLUT Intercept (knight catch %)', desc: 'Chance a transporter successfully captures glucose', min: 0.1, max: 1.0, step: 0.05 },
  { key: 'PANCREAS_AUTO_SPAWN_INTERVAL_0', label: 'Insulin Secretion (priest spawn, sec)', desc: 'Seconds between insulin auto-release at IR 0', min: 0.5, max: 10, step: 0.25, configPath: ['PANCREAS_AUTO_SPAWN_INTERVAL', 0] },
  { key: 'PANCREAS_MAX_PRIESTS_0', label: 'Max Insulin (max priests at IR 0)', desc: 'Maximum circulating insulin at IR 0', min: 1, max: 15, step: 1, configPath: ['PANCREAS_MAX_PRIESTS', 0] },
  { key: 'RESISTANCE_0', label: 'Insulin Sensitivity (convert chance at IR 0)', desc: 'Probability of successful glucose uptake at IR 0', min: 0.1, max: 1.0, step: 0.05, configPath: ['RESISTANCE_BY_DEGRADATION', 0] },
  { key: 'REBEL_HP', label: 'Free Glucose HP (rebel health)', desc: 'Health of unconverted glucose before it dies', min: 20, max: 200, step: 10 },
  { key: 'REBEL_BUILDING_DPS', label: 'Hyperglycemia Damage (rebel DPS)', desc: 'DPS dealt by free glucose to organs', min: 1, max: 20, step: 1 },
  { key: 'DAY_SPEED', label: 'Day Speed (game minutes per real sec)', desc: 'Virtual minutes per real second', min: 1, max: 10, step: 0.5 },
  { key: 'WALK_COST', label: 'Walk Energy Cost (ATP)', desc: 'ATP spent for light walk', min: 0, max: 50, step: 5 },
  { key: 'EXERCISE_COST', label: 'Training Energy Cost (ATP)', desc: 'ATP spent for exercise', min: 0, max: 100, step: 5 },
  { key: 'PRIEST_WAIT_TIMEOUT', label: 'Glucose Aggro Timer (sec to become rebel)', desc: 'Seconds before free glucose becomes hostile', min: 5, max: 60, step: 1 },
];
